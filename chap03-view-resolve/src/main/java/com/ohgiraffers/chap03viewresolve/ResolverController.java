...
public class ResolverController {
    ...
    public String stringReturning(Model model){
        ...
        * resources/templates/result.html 파일로 응답뷰를 설정하라는 의미가 된다.
        * */
        return "result";
    }
    ...
    * 하지만 스프링에서는 redirectAttributes 타입을 통해 redirect 시 속성 값을 저장할 수 있도록
    ...
    public String stringRedirectFlashAttribute(RedirectAttributes rttr){
         ...
         * 세션에 임시로 값을 담고 소멸하는 방식이기 때문에 session에 동일한 키깞이 졶재하지 않아야한다.
         * **/
    ...
    public ModelAndView modelAndViewReturing(ModelAndView mv){
         ...
         * 이 때 문자열을 반환해도 되지만 ModelAndVIEW를 미리 만들어 반환할 수 도 있따.
         * **/
