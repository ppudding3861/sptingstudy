 ...
 * 필터는 모든 요청과 응답을 가로채며, 주로 보안, 로깅, 인증 등과 같은 작업을 수행한다.
 *
 * interceptor
 * spring mvc 레벨에서 동작하며 spring의 handler interceptor 인터페이스를 구현한다.
 ...
 *
 * interceptor
 * spring mvc 핸둘러 메서드에만 적용된다.
 * 특정 url 패턴이나 특정 핸틀러 매서드에만 적용 할수 있다.
 * */
